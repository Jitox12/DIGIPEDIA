...
public class AttributeController {
    ...
    public GAttributeDto findAttributeByIdController(@PathVariable Integer attributeId){
    ...
    public GAttributeDto findAttributeByNameController(@PathVariable String attributeName){
        GAttributeDto attributeDto;
